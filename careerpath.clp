...
(defrule init "menu"
    ...
    (printout t "-Project Management-PgMP, PMP, PRINCE2, PfMP, CAPM, PMI-RMP, PMI-SP" crlf)
    (printout t "-Auditing-CISA, GSNA" crlf)
    (printout t "-Security- CISM, CommpTIA Security+, CCFP, CISSP,SSCP,CAP,CEH, " crlf)
    (printout t "-machine-learning- CCP, " crlf)
    (printout t "-documenting-CISE, " crlf)
    (printout t "-Programming- MCSD, ACE, C/C++, CSSLP," crlf)
    (printout t "-healthcare- CHA, CAHIMS, CPHIMS, HCISPP" crlf)
    (printout t "*****************************" crlf)
